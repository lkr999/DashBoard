                    ...
                    children=[
                        dmc.ScrollArea(
                            ...
                            children=[
                                ...
                                dmc.Group(
                                    ...
                                    children=[
                                        ...
                                        create_main_nav_link(
                                            ...
                                            href=qc_app2.get_relative_path("/board_status"),
                                        ),
                                    ],
                                ),

                                #Base Date of Inventory ----
                                dmc.Divider(label='Base Date',labelPosition='center' ,color='white',size=2, style={"marginBottom": 10, "marginTop": 20}),
                                dmc.Group(
                                    display="column",
                                    children=[
                                        dmc.Switch(
                                ...
                                # Date Range ----
                                dmc.Divider(label='Date Range',labelPosition='center' ,color='white',size=2, style={"marginBottom": 10, "marginTop": 20}),
                                dmc.Group(
                                    display="column",
                                    children=[
                                        dmc.DateRangePicker(
                                            ...
                                            style={"width": 250, "text-color":"red"},
                                        ),
                                    ],
                                ),

                                #Period ----
                                dmc.Divider(label='Period Select',labelPosition='center' ,color='white',size=2, style={"marginBottom": 0, "marginTop": 20}),
                                dmc.Group(
                                    display="column",
                                    children=[
                                        dmc.RadioGroup(
                                ...
                                #Board Level Select ----
                                dmc.Divider(label='Evaluate Select',labelPosition='center' ,color='white',size=2, style={"marginBottom": 10, "marginTop": 30}),
                                dmc.Group(
                                    display="column",
                                    children=[
                                        dmc.ChipGroup(
                                ...
                                #Board Units ----
                                dmc.Divider(label='Units of Board',labelPosition='center' ,color='white',size=2, style={"marginBottom": 0, "marginTop": 20}),
                                dmc.Group(
                                    display="column",
                                    children=[
                                        dmc.RadioGroup(
                                ...
                                #Board Level ----
                                dmc.Divider(label='Board Level',labelPosition='center' ,color='white',size=2, style={"marginBottom": 0, "marginTop": 20}),
                                dmc.Group(
                                    children=[
                                        dmc.ChipGroup(
