        ...
        dmc.Group(
            ...
            children=[
                dmc.Select(
                    ...
                    data=["In Sotck Status of Each Products",'Trend Analyze Input/Output of Boards', 'Output Status', 'Input Status'],
...
def BoardStatus(date_range, baseInventory_date, radio_period, level_checkList, unit_Analyze, select_graph, select_boardname, select_groupby, x_axis, data_copy, oneday_range):
    TODAY = date.today()
    ...
    if select_graph=='In Sotck Status of Each Products':

        gr_by = ['BoardName','MarketGroup',]
        x_val = 'BoardName'

        if len(select_groupby) >= 1 and len(x_axis) >= 1:
    ...
    if select_graph == 'Output Status':
        ...
        selected_group_items = [Period, 'MarketGroup', 'Level', 'Customer', 'Vendor', 'Category1', 'Category2', 'BoardName_y']
        selected_xaxis_items = [Period, 'MarketGroup', 'Level', 'Customer', 'Vendor', 'Category1', 'Category2', 'BoardName_y']
