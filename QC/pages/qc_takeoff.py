...
def update_contents(date_range, baseInventory_date, radio_period, level_checkList, unit_Analyze, oneday_range,
    ...
    try:
        ...
        if select_graph=='Evaluation Status(Time Base)':
            ...
            df_bar_2 = df_no_qry.query(qry_last_txt)[['Date2', 'BoardName', 'LotNo', 'Time2', 'Evaluate', 'Discription', 'Quantity', 'Qty_sqm', 'Qty_pcs', 'Qty_pt','EV_point']].sort_values(by=['BoardName', 'LotNo'], ascending=True)
